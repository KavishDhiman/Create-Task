    ...
    public class NotificationController {
        ...
        @GetMapping("/notifications/{notificationId}") // Handles GET /api/v1/notifications/{notificationId}
        public ResponseEntity<NotificationResponseDTO> getNotification(
                ...
                @PathVariable int notificationId) { // Extracts notificationId from the URL path segment
        ...
        public ResponseEntity<List<NotificationResponseDTO>> getUserNotifications(
                ...
                @PathVariable int userId) { // Extracts userId from the URL path segment
